<?php
require_once 'ad_config.php'; // Include database connection configuration
...
<head>
    ...
    <style>
        body {
            background: url(https://i.pinimg.com/originals/6b/7c/72/6b7c72de8c9fdb5bbeb5feca23fcc74e.gif);
